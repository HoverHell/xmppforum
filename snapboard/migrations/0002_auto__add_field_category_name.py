...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('snapboard_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.name'
        db.delete_column('snapboard_category', 'name')
