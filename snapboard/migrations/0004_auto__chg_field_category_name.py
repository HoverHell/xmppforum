...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('snapboard_category', 'name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=16))


    def backwards(self, orm):
        
        # Changing field 'Category.name'
        db.alter_column('snapboard_category', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16, null=True))
